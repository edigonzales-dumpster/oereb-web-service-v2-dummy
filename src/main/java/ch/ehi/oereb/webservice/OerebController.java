...
//        logger.info("env.dburl {}",dburl);
    ...
    public ResponseEntity<?> dummy() {
      ...
      extractType.setCreationDate(today);
      extractType.setExtractIdentifier(UUID.randomUUID().toString());

      
      RealEstateDPRType gs = new  RealEstateDPRType();
      gs.setEGRID("CHXXXXXXXXXXX");
      gs.setCanton(CantonCodeType.fromValue("SO"));
      gs.setLandRegistryArea(999);
      gs.setMunicipalityCode(2601);
      ...
      }
      {
          ...
          foo.setTheme(themeType);
          foo.setTypeCode("in_Bauzone");
          foo.setAreaShare(100);
          foo.setTypeCodelist("urn:fdc:ilismeta.interlis.ch:2017:Typ_Kanton_Waldgrenzen");
          gs.getRestrictionOnLandownership().add(foo);
      }
      {
          RestrictionOnLandownershipType foo = new RestrictionOnLandownershipType();
          ...
          themeType.setText(createMultilingualTextType("Statische Waldgrenzen"));
          foo.setTheme(themeType);
          foo.setTypeCode("ausserhalb_Bauzone");
          foo.setTypeCodelist("urn:fdc:ilismeta.interlis.ch:2017:Typ_Kanton_Waldgrenzen");
      ...
      Extract extract = new Extract(extractType);
